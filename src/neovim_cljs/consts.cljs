...
(def neovim-api
  (mapv #(gstr/replaceAll %  "_" "-")
        '("nvim_buf_line_count"
          ...
          "nvim_buf_get_keymap" "nvim_buf_set_var"
          "nvim_buf_del_var" "buffer_set_var"
          "buffer_del_var" "nvim_buf_get_option"
          "nvim_buf_set_option" "nvim_buf_get_number"
          "nvim_buf_get_name" "nvim_buf_set_name"
          "nvim_buf_is_valid" "buffer_insert"
          "nvim_buf_get_mark" "nvim_buf_add_highlight"
          ...
          "ui_attach" "nvim_ui_detach"
          "nvim_ui_try_resize" "nvim_ui_set_option"
          "nvim_command" "nvim_get_hl_by_name"
          "nvim_get_hl_by_id" "nvim_feedkeys"
          "nvim_input" "nvim_replace_termcodes"
          "nvim_command_output" "nvim_eval"
          "nvim_call_function" "nvim_execute_lua"
          ...
          "tabpage_get_window" "tabpage_is_valid"
          "ui_detach" "ui_try_resize" "vim_command"
          "vim_feedkeys" "vim_input"
          "vim_replace_termcodes" "vim_command_output"
          "vim_eval" "vim_call_function" "vim_strwidth"
          "vim_list_runtime_paths" "vim_change_directory"
          "vim_get_current_line" "vim_set_current_line"
          "vim_del_current_line" "vim_get_var"
          "vim_get_vvar" "vim_get_option"
          "vim_set_option" "vim_out_write"
          "vim_err_write" "vim_report_error"
          "vim_get_buffers" "vim_get_current_buffer"
          "vim_set_current_buffer" "vim_get_windows"
          "vim_get_current_window"
          "vim_set_current_window" "vim_get_tabpages"
          "vim_get_current_tabpage"
          "vim_set_current_tabpage" "vim_subscribe"
          "vim_unsubscribe" "vim_name_to_color"
          "vim_get_color_map" "vim_get_api_info"
          "window_get_buffer" "window_get_cursor"
          "window_set_cursor" "window_get_height"
          "window_set_height" "window_get_width"
          "window_set_width" "window_get_var"
          "window_get_option" "window_set_option"
          "window_get_position" "window_get_tabpage"
          "window_is_valid")))
